...
class appProdProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => '', 'dbname' => 'prestashop2', 'user' => 'root', 'password' => '', 'charset' => 'UTF8', 'driverOptions' => array(1002 => 'SET sql_mode=(SELECT REPLACE(@@sql_mode,\'ONLY_FULL_GROUP_BY\',\'\'))'), 'serverVersion' => 5.0999999999999996), new \Doctrine\DBAL\Configuration(), $a, array('enum' => 'string'));
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_ac75c45da18646d211af2517f012efe9861bcbdd67cd70072a6f2613c1bf60d6');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('5DtKHfLk6fjEWodgxj98QMNSWrqkzRKJroY99ooSJeyrN8eLb211o11f');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('59ecb03e9e1887.76828413')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'secret' => '5DtKHfLk6fjEWodgxj98QMNSWrqkzRKJroY99ooSJeyrN8eLb211o11f',
            'ps_caching' => 'CacheMemcache',
            'ps_cache_enable' => false,
            'ps_creation_date' => '2017-10-22',
            'locale' => 'pl-PL',
            'cookie_key' => '5bHLNSn00TTvWJLFJe459syQh3ytAZwgycesWUZ7z34rOUUSgekfBcqA',
            'cookie_iv' => 'HA4MKpTb',
            'new_cookie_key' => 'def000000cd26863a97c536f71f5e3d1ba1e2420ef713f08492199bf52539b86568d275f0cff84437f703c0c73f28b4d6d85343a155bc91e809861e187f303c78ed2084d',
            ...
            'kernel.secret' => '5DtKHfLk6fjEWodgxj98QMNSWrqkzRKJroY99ooSJeyrN8eLb211o11f',
